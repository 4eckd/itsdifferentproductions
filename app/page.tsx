    ...
    <main className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="mb-12">
            <h4 className="text-xl font-bold text-white mb-6 text-center">
              🎵 <span className="text-purple-400">Vocal Styles</span>
            </h4>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 max-w-6xl mx-auto">
              {['Rapping', 'Country', 'Jazz', 'Afro', 'Ethnic', 'Musical theater'].map((style, index) => (
                <motion.div
                  key={index}
                  ...
                  className="relative group"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-lg blur-sm opacity-25 group-hover:opacity-45 transition-opacity animate-pulse" />
                  <div className="relative bg-black/80 backdrop-blur-sm border border-purple-500/30 rounded-lg p-3 hover:border-purple-400/50 transition-all duration-300">
                    <div className="text-center mb-2">
                      <h5 className="text-sm font-semibold text-white">{style}</h5>
                    </div>
                    <Button
                      size="sm"
                      className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 group/btn text-xs"
                      asChild
                    >
                      <a href={`mailto:hello@itsdifferentproductions.com?subject=Audition for ${style} Vocalist`}>
                        Audition
                        <ArrowRight className="h-3 w-3 ml-1 transition-transform group-hover/btn:translate-x-1" />
                      </a>
                    </Button>
          ...
          <div className="mb-12">
            <h4 className="text-xl font-bold text-white mb-6 text-center">
              🎙️ <span className="text-cyan-400">Vocal Timbres</span>
            </h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {['Deep low', 'Growl', 'Rough, hoarse', 'Kid voice'].map((timbre, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  className="relative group"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-lg blur-md opacity-25 group-hover:opacity-45 transition-opacity animate-pulse" />
                  <div className="relative bg-black/80 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 hover:border-cyan-400/50 transition-all duration-300">
                    <div className="text-center mb-3">
                      <h5 className="text-lg font-semibold text-white">{timbre}</h5>
                    </div>
                    <Button
                      size="sm"
                      className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 group/btn"
                      asChild
                    >
                      <a href={`mailto:hello@itsdifferentproductions.com?subject=Audition for ${timbre} Voice`}>
                        Submit Demo
                        <ArrowRight className="h-3 w-3 ml-1 transition-transform group-hover/btn:translate-x-1" />
                      </a>
                    </Button>
          ...
          <div className="mb-12">
            <h4 className="text-xl font-bold text-white mb-6 text-center">
              🎻 <span className="text-green-400">Priority Instruments</span>
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {[
                { name: 'Violin', status: 'Available', timeline: '1 mo' },
                { name: 'Viola', status: 'In development', timeline: '1 mo' },
                { name: 'Cello', status: 'In development', timeline: '2 mo' },
                { name: 'Ethnic strings', status: 'In development', timeline: '2 mo' }
                ...
                <motion.div
                  ...
                  className="relative group"
                >
                  <div className={`absolute inset-0 rounded-lg blur-md opacity-25 group-hover:opacity-45 transition-opacity animate-pulse ${
                    instrument.status === 'Available'
                      ? 'bg-gradient-to-r from-green-400 to-emerald-400'
                      : 'bg-gradient-to-r from-yellow-400 to-orange-400'
                  }`} />
                  <div className={`relative bg-black/80 backdrop-blur-sm border rounded-lg p-4 transition-all duration-300 ${
                    instrument.status === 'Available'
                      ? 'border-green-500/30 hover:border-green-400/50'
                      : 'border-yellow-500/30 hover:border-yellow-400/50'
                  }`}>
                    <div className="text-center mb-3">
                      <h5 className="text-lg font-semibold text-white mb-1">{instrument.name}</h5>
                      <Badge
                        variant="secondary"
                        className={`text-xs ${
                          instrument.status === 'Available'
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <a href={`mailto:hello@itsdifferentproductions.com?subject=Audition for ${instrument.name} Player`}>
                        Submit Demo
                        <ArrowRight className="h-3 w-3 ml-1 transition-transform group-hover/btn:translate-x-1" />
                      </a>
                    </Button>
          ...
          <div className="mb-12">
            <h4 className="text-xl font-bold text-white mb-6 text-center">
              🎺 <span className="text-blue-400">Future Instruments</span> (This Year)
            </h4>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 max-w-6xl mx-auto">
              {[
                'Saxophone', 'Trumpet', 'Trombone', 'Horn', 'Clarinet', 'Flute',
                'Acoustic guitar', 'Electric guitar', 'Bass guitar', 'Ukulele', 'Piano', 'Drums'
              ].map((instrument, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  ...
                  className="relative group"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-lg blur-sm opacity-20 group-hover:opacity-35 transition-opacity animate-pulse" />
                  <div className="relative bg-black/80 backdrop-blur-sm border border-blue-500/30 rounded-lg p-2 hover:border-blue-400/50 transition-all duration-300">
                    <div className="text-center mb-2">
                      <h5 className="text-xs font-semibold text-white">{instrument}</h5>
                    </div>
                    <Button
                      size="sm"
                      className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 group/btn text-xs py-1"
                      asChild
                    >
                      <a href={`mailto:hello@itsdifferentproductions.com?subject=Audition for ${instrument} Player`}>
                        Apply
                        <ArrowRight className="h-2 w-2 ml-1 transition-transform group-hover/btn:translate-x-1" />
                      </a>
                    </Button>
                  </div>
                </motion.div>

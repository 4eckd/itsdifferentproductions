...
create_environment_file() {
    ...
    cat > .env.dns << EOF
# Generated by setup-docs.sh on $(date)
...
EOF
    ...
    print_success "Environment file created: .env.dns"
}
...
main() {
    ...
    if [[ "$1" != "--config-only" ]]; then
        ...
        print_success "Configuration complete. Run './scripts/deploy-docs.sh' to deploy."
    fi
}

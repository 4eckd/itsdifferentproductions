...
export function DiscordInvite() {
  ...
  useEffect(() => {
    ...
    const hasSeenDiscordInvite = localStorage.getItem("hasSeenDiscordInvite");
  ...
  const handleDismiss = () => {
    ...
    localStorage.setItem("hasSeenDiscordInvite", "true");
  };
      ...
      {isVisible && (
        ...
        >
          <div className="relative overflow-hidden rounded-xl border bg-background shadow-lg">
            {/* Discord-themed header */}
            <div className="bg-[#5865F2] px-6 py-4 text-white">
